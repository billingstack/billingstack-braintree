...
import textwrap
from billingstack_braintree.openstack.common import setup as common_setup
...
setup(
    ...
    url='https://github.com/billingstack/billingstack-braintree',
    ...
    entry_points=textwrap.dedent("""
        ...
        braintree = billingstack_braintree.provider:BraintreeProvider
    """),
    classifiers=[
